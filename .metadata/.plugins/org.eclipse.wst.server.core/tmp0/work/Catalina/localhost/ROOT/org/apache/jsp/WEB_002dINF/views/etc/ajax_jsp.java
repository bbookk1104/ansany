 ...
 * Generated at: 2022-09-08 06:14:38 UTC
...
if(m==null) {
      ...
      out.write("				type : \"post\",\r\n");
      out.write("				data : {num1:su1, num2:su2}, //key:value - key는 문자열데이터\r\n");
      ...
      out.write("				dataType: \"json\", //객체쓰려면 json타입인걸 명시해야함(함수에서 하거나 서블릿에서 하거나)\r\n");
      out.write("				success: function(data){//data가 아닌 다른 변수명이어도 상관없음\r\n");
      ...
      out.write("			console.log(\".then(function())이용 *동기같은 비동기 : \"+test);				\r\n");
      out.write("			});\r\n");
      out.write("			console.log(\"이벤트 끝 *비동기 : \"+test);\r\n");
      out.write("		});\r\n");
      out.write("	</script>\r\n");
      out.write("	");
      out.write("\r\n");
